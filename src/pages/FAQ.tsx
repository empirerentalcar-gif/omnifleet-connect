...
const faqData = {
  ...
  "For Agencies": [
    { q: "How much does it cost to join ZUVIO?", a: "ZUVIO offers one simple plan:\n\n• Founding Member Plan: $79/month + 5% per confirmed booking\n• 60 days free for founding members (limited to the first 50 agencies)\n• Your rate is locked for life once you join\n\nNo hidden fees. No long-term contracts. Cancel anytime. You keep full control of your business." },
  ...
  "General": [
    ...
    { q: "How does ZUVIO make money?", a: "ZUVIO charges partner agencies $79/month plus a 5% fee on confirmed bookings. This ensures we only succeed when our partners succeed.\n\nFor renters, using ZUVIO is completely free. We never charge customers booking fees or mark up rental prices." },
