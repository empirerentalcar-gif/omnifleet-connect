        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-3">
                Agencies connecting a payment processing account to Zuvio acknowledge and agree that they act as the primary Merchant of Record for all digital transactions completed for their vehicles. As the Merchant of Record, the agency assumes 100% financial and legal responsibility for all renter disputes, bank chargebacks, fraudulent transactions, and associated processing or dispute fees. Zuvio reserves the right to withhold future transaction payouts, freeze pending platform transfers, or issue automated Stripe transfer reversals to fully recover funds from the agency's connected account in the event of an active or lost dispute. Agencies are contractually required to maintain active commercial auto liability insurance with a minimum coverage of $1,000,000 per occurrence for all vehicles listed on the Zuvio platform, and proof of coverage must be made available to Zuvio upon request. Failure to maintain this insurance is grounds for immediate listing removal and account termination. The Agency explicitly agrees to indemnify, defend, and hold Zuvio harmless from any claims, damages, lawsuits, or expenses arising from bodily injury, property damage, vehicle defects, maintenance failures, or any other liability occurring during a rental period facilitated through the Zuvio platform.
              </p>
            </section>
