-- Remove leftover declined/canceled bookings tied to the two agencies (FK requirement)
DELETE FROM public.bookings
WHERE agency_id IN ('73c087c4-3d16-45e5-970c-a6f3f643c78d', '2bc36f79-8593-486d-adb2-89349b88d53a');

-- Delete the two founding-member agencies so their numbers free up
DELETE FROM public.agencies
WHERE id IN ('73c087c4-3d16-45e5-970c-a6f3f643c78d', '2bc36f79-8593-486d-adb2-89349b88d53a');

-- Update signup handler so new founding members reclaim the lowest unused number (1..50)
...
BEGIN
  ...
  ELSE
    ...
    IF is_founding THEN
      trial_days := 60;
      -- Lowest unused founding number 1..50 (reclaims freed slots)
